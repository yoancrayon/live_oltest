...
<script src="<?php echo base_url('assets/js/ellipsis.js'); ?>"></script>
<!--
...
<title>Hasil Ujian - livE Online Java Exercise</title>
</head>
<body>
...
<div class="modal fade" id="modalcenter" tabindex="-1" role="dialog" aria-labelledby="JudulModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
	...
	<script src="<?php echo base_url('assets/js/hasil.js'); ?>"></script>
